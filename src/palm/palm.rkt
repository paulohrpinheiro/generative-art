...
(define (leaf p)
  (let ((r (realRandom)))
    (cond ((< r 0.20) (transform p (cons  0.00  0.00) (cons  0.00 0.16) 0.10 0.00))
          ((< r 0.54) (transform p (cons  0.85  0.04) (cons -0.04 0.85) 0.20 5.00))
          ((< r 0.78) (transform p (cons  0.20 -0.26) (cons  0.23 0.22) 0.30 0.00))
          ((< r 0.85) (transform p (cons -0.15 -0.28) (cons  0.26 0.24) 0.40 0.00))
